...
# =============================================================
# APP STREAMLIT – PRESUPUESTO DE CONSTRUCCIÓN COMPLETO
# =============================================================
...
# -------------------------------------------------------------
st.set_page_config(
    page_title="Presupuesto de Construcción",
    layout="wide"
)
...
plantilla_ejemplo = pd.DataFrame([
    ["EARTHWORK", "T01", "Excavación manual", "mano_obra", "m3", 120, 1, 25000, 1.00, "obrero", 2.5],
    ...
    ["CONCRETO", "L01", "Oficial de construcción", "mano_obra", "h", 80, 1, 23000, 1.00, "oficial", 4.0],
], columns=plantilla_cols)

st.subheader("📄 Cargar Partidas")
...
# -------------------------------------------------------------
# 3. PARÁMETROS AIU E IVA
# -------------------------------------------------------------
st.subheader("⚙️ Parámetros AIU e IVA")

col1, col2, col3, col4 = st.columns(4)

admin = col1.number_input("Administración (%)", 0.0, 1.0, 0.08)
...
st.write(f"### ✅ TOTAL FINAL: ${resumen['total_final']:,.0f}")

# -------------------------------------------------------------
# 6. EXPORTAR A EXCEL
# -------------------------------------------------------------
st.subheader("⬇️ Descargar Reporte Excel")
...
def exportar_excel(df_calc, resumen):
    ...
    with pd.ExcelWriter(output, engine="xlsxwriter") as writer:
        ...
        ]).to_excel(writer, sheet_name="Capítulos", index=False)
